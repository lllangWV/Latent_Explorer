...
from latentexp.common.constants import CompScalerMeans, CompScalerStds
from latentexp.common.data_utils import StandardScaler, chemical_symbols
from latentexp.pl_data.dataset import TensorCrystDataset
from latentexp.pl_data.datamodule import worker_init_fn
...
def get_model_path(eval_model_name):
    import latentexp
    model_path = (
        Path(latentexp.__file__).parent / 'prop_models' / eval_model_name)
    return model_path
